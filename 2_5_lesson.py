...
class HybridCars(OilCars, ElectroCars):
    ...
    def get_hybrif_car_info(self):
        return f"Hybrid type: {self.hybrid_type}"


h1 = HybridCars("BYD", 'Chazor', 'black', 2025 , 95, 100, 1.5, 144.4, 1200, 'Plagin')
print(h1.get_electro_car_info())
'''
...
#     print(c)
# except TypeError:
#     print("son va tekstni qo'shib bo'lmaydi")
